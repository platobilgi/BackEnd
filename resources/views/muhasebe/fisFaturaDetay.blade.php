...
@section('content')
    @section('title')
        Gider Faturası Detay
        @endsection
<div class="row">
    <div class="col-sm-9 ">
        <div class="widget">
            <div class="widget-header ">
                <h2><i class="icon-chart-pie-1"></i> <strong>Gider</strong> Faturası</h2>
            ...
            <div class="widget-content padding">
                <div class="row">
                    ...
                    <div class="col-md-3" >
                        <a href="{{URL::route('giderler.fisfaturaDuzenle',$gider->id)}}"> <button style="float: right" class="ui purple basic button">Düzenle</button></a>
                ...
                <div class="col-md-12">
                    ...
                    <div class="col-md-4"><a class="ui basic purple label" style="border: none;width: 100%" >{{$gider->description}}</a></div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="col-md-2"><a class="ui basic purple label" style="width: 100%">Düzenlenme Tarihi :</a></div>
                        <div class="col-md-4"><a class="ui basic purple label" style="border: none;width: 100%">{{$gider->issue_date}}</a></div>
                        <div class="col-md-2"><a class="ui basic purple label" style="width: 100%">Ödeme Tarihi :</a></div>
                        <div class="col-md-4"><a class="ui basic purple label" style="border: none;width: 100%">{{$gider->expiry_date}}</a></div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="col-md-2"><a class="ui basic purple label" style="width: 100%">Toplam Tutar :</a></div>
                        <div class="col-md-4"><a class="ui basic purple label" style="border: none;width: 100%">{{$gider->fee}}<i class="fa fa-try"></i> </a></div>

                        <div class="col-md-2"><a class="ui basic purple label" style="width: 100%">KDV Oranı:</a></div>
                        <div class="col-md-4"><a class="ui basic purple label" style="border: none;width: 100%">% {{$gider->vat}} </a></div>
...
<div class="ui basic modal">
    ...
    <div class="actions">
        ...
        <a href="{{URL::route('giderler.faturasil',$gider->id)}}"> <div class="ui green ok inverted button">
...
<div class="md-modal md-fade-in-scale-up" id="md-fade-in-scale-up">
    <div class="md-content">
        ...
        <div>
            {{Form::model($payment,array('route' => ['giderler.odemeekle',$gider->id] , 'method' => 'post'))}}
            <div class="col-md-12">
