    ...
    <div class="col-sm-12 portlets">
        <div class="widget">
            ...
            <div class="widget-content padding">
                {{Form::model($musteri,array('route' => ['satislar.musteriduzenlepost',$musteri->id] , 'method' => 'post'))}}
                ...
                <div class="form-group">
                    <div >
                        <div class="form-group">
                            <label onclick="gercekkisi()"><input type="radio" onselect="gercekkisi()" class="ui radio checkbox" name="types_id" value="1"@if($musteri->types_id==1) {{' checked'}} @endif  style="margin-right: 5px"> Gerçek Kişi</label>
                            <label onclick="tuzelkisi()"><input type="radio" onselect="tuzelkisi()" class="ui radio checkbox" name="types_id" value="2" @if($musteri->types_id==2) {{' checked'}} @endif   style="margin-right: 5px"> Tüzel Kişi</label>
                        </div>
                ...
                <div class="form-group">
                    ...
                    {{Form::number('tax_number', null,array('class'=> 'form-control','id'=>'tax_number'))}}
                </div>


                <div class="form-group">
                    <label id="tax_administratorlb">Vergi Dairesi</label>
                    {{Form::text('tax_administrator', null,array('class'=> 'form-control','id'=>'tax_administrator'))}}
                </div>
                <div class="form-group">
                    <label id="identification_numberlb" >TC Kimlik Numarası</label>
                    {{Form::number('identification_number', null,array('class'=> 'form-control','id'=>'identification_number'))}}
                </div>
                <div class="form-group">
                    <label>Açılış Bakiyesi</label>
                    {{Form::number('balance', null,array('class'=> 'form-control','id'=>'balance','step'=>'0.001'))}}
        ...
        <div class="widget">
            ...
            <div class="widget-content padding">
                <table id="tablocuk" style="width: 100%">
                    ...
                    <tr>
                        <td>{{Form::text('manager_name', $manager->name,array('class'=> 'form-control'))}}</td>
                        <td>{{Form::email('manager_email', $manager->email,array('class'=> 'form-control'))}}</td>
                        <td>{{Form::number('manager_phone',$manager->phone_number,array('class' => 'form-control' ))}}</td>
                        <td>{{Form::text('manager_notes',$manager->notes,array('class' => 'form-control' ))}}</td>
                    </tr>
                </table>
            </div>
        </div>
