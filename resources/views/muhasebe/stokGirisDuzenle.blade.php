    ...
    <div class="col-sm-12 portlets">
        <div class="widget">
            ...
            <div class="widget-content padding">
                {{Form::model($stok,array('route' => ['stok.stokgirisduzenle',$stok->id] , 'method' => 'post'))}}
                ...
                <div class="form-group">
                        ...
                        {{Form::text("suppliers",$supplier->name,array('class'=>'form-control','id'=>'suppliers'))}}
                ...
                <div class="form-group">
                    <label>Ürün</label>
                    {{Form::text('products',$product->name,array('class' => 'form-control','id'=>'products'))}}
                    {{Form::text('products_id',$stok->products_id,array('class' => 'form-control','style'=>'display:none','id'=>'products_id'))}}
                ...
                <div class="form-group">
                    <label>Birim</label>
                    {{Form::text('unit',$stok->unit,array('class' => 'form-control','id'=>'miktar'))}}
