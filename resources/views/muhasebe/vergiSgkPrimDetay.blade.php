...
@section('content')
@section('title')
    Vergi/Sgk Prim Gideri Detayı
@endsection
<div class="row">
    <div class="col-sm-9 ">
        <div class="widget">
            <div class="widget-header ">
                <h2><i class="icon-chart-pie-1"></i> <strong>Vergi/SGK</strong> Prim  <strong>Gideri</strong> Detayı</h2>
            ...
            <div class="widget-content padding">
                <div class="row">
                    ...
                    <div class="col-md-3" >
                        <a href="{{URL::route('giderler.vergiDuzenle',$gider->id)}}"> <button style="float: right" class="ui yellow basic button">Düzenle</button></a>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="col-md-2"><a class="ui basic yellow label" style="width: 100%">Açıklama :</a></div>
                        <div class="col-md-4"><a class="ui basic yellow label" style="border: none;width: 100%" >{{$gider->description}}</a></div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="col-md-2"><a class="ui basic yellow label" style="width: 100%">Düzenlenme Tarihi :</a></div>
                        <div class="col-md-4"><a class="ui basic yellow label" style="border: none;width: 100%">{{$gider->issue_date}}</a></div>
                        <div class="col-md-2"><a class="ui basic yellow label" style="width: 100%">Ödeme Tarihi :</a></div>
                        <div class="col-md-4"><a class="ui basic yellow label" style="border: none;width: 100%">{{$gider->expiry_date}}</a></div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="col-md-2"><a class="ui basic yellow label" style="width: 100%">Toplam Tutar :</a></div>
                        <div class="col-md-4"><a class="ui basic yellow label" style="border: none;width: 100%">{{$gider->fee}}<i class="fa fa-try"></i> </a></div>
                    </div>
                </div>
...
<div class="ui basic modal">
    <div class="ui icon header">
        ...
        Vergi/SGK Gideri Siliniyor
    </div>
    <div class="content">
        <p>Bu işlemi onaylamanız durumunda vergi/Sgk gideri geri dönüşü olmaksızın silinecektir.Devam etmek istediğinize emin misiniz?</p>
    </div>
    <div class="actions">
        ...
        <a href="{{URL::route('giderler.vergisil',$gider->id)}}"> <div class="ui green ok inverted button">
