...
<div class="container">
    <div class="full-content-center animated flipInX">
        <h1>Hata!</h1>
        <h2>Erişim sınırı limitine ulaştınız! Erişmeye çalıştığınız sayfa yetkiniz dışında kalmaktadır.</h2><br>
        <p class="text-lightblue-2">Geriye dönmek ve işlemlerinize devam etmek için panele geri dönün;</p>
       <br>
        <a class="btn btn-primary btn-sm" href="{{URL::route('panel')}}"><i class="fa fa-angle-left"></i> Panele Dön</a>
    </div>
</div>
<!-- End of page -->
