        ...
        <div class="row mt">
            <div class="col-lg-12">
                <div class="form-panel">
                    <h4 class="mb"><i class="fa fa-angle-right"></i> Alt Menü Düzenle</h4>
                        <form role="form" class="form-horizontal style-form" method="POST" action="{{URL::route('admin.menuler.updatesub',$menu->id)}}">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input id="menu_id" name="menu_id" type="number" value="{{$menu->menus_id}}" class="form-control">
